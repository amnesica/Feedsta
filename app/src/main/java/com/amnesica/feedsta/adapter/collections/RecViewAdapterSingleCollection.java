...
public class RecViewAdapterSingleCollection
      ...
      new ActionMode.Callback() {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
          ...
          if (itemId == R.id.menu_remove_multiple_bookmarks) {
            ...
            listWithPostsInAllCollection =
                listTmpSelectedPosts.stream()
                    .filter(post -> post != null && post.getCategory() == null)
  ...
  @NonNull
  @Override
  public RecViewAdapterSingleCollection.ViewHolder onCreateViewHolder(
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    /**
     * Shows an icon in the top right corner to mark the bookmark as selected or to indicate that
     * bookmark is a video or a sidecar post
     *
     * @param post Post
     */
