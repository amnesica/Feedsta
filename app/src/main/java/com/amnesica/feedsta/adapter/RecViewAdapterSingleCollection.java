 ...
 */
public class RecViewAdapterSingleCollection extends RecyclerView.Adapter<RecViewAdapterSingleCollection.ViewHolder> {
    ...
    private final ActionMode.Callback actionModeCallbacks = new ActionMode.Callback() {
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                case R.id.menu_remove_multiple_bookmarks:
                ...
                case R.id.menu_change_category_bookmarks:
                ...
                case R.id.menu_download_bookmarks:
                    if (listener != null && !selectedPosts.isEmpty()) {
                ...
                case R.id.menu_reset_category_bookmarks:
                    ...
                    if (listWithPostsInAllCollection != null && !listWithPostsInAllCollection.isEmpty()) {
                        if (context != null) {
                            Toast.makeText(context,
                                    context.getString(R.string.operation_can_only_be_applied_to_bookmarks_with_coll), Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final String url = listPostsInCollectionBookmarked.get(position).getImageUrlThumbnail();
    ...
    private void removeBookmarksWithDialogFirst() {
        ...
        alertDialogBuilder = new AlertDialog.Builder(context)
                .setTitle(R.string.remove_bookmarks_confirm_dialog_title)
                .setMessage(R.string.remove_bookmarks_confirm_dialog_message)
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * Selects a bookmark and shows the "checked" icon
        ...
        private void showIconToPostInCorner(Post post) {
