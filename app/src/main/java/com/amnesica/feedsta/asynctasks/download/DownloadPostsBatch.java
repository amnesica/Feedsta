  ...
  private Sidecar getSidecarFromEdge(JSONArray edges) throws JSONException {
    ...
    private void downloadVideo(Post post, String videoUrlSidecar) {
        ...
        try {
            ...
            // save video
            boolean saved = StorageHelper.saveVideo(inputStream, buffer, post.getUsername(),
    ...
    private void showProgressDialog() {
        ...
        progressDialogBatch.setTitle(
                fragment.requireContext().getString(R.string.progress_dialog_title_download_selected_posts));
