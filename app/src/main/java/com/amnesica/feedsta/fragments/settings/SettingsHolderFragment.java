package com.amnesica.feedsta.fragments.settings;
...
/**
 * Fragment is the main container for the settings fragment and holds the toolbar. Hint: otherwise
 * toolbar cannot be shown!
 */
public class SettingsHolderFragment extends Fragment {
  ...
  private void setupToolbar(View view) {
    ...
    FragmentHelper.setupToolbarWithBackButton(
        toolbar, new WeakReference<>(SettingsHolderFragment.this));
